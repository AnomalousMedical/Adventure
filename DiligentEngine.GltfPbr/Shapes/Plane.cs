...
namespace DiligentEngine.GltfPbr.Shapes
{
    public class Plane : IDisposable
    {
        ...
        unsafe void CreateVertexBuffer(IRenderDevice m_pDevice)
        {
            ...
            {
                new GLTFVertex{pos = new Vector3(-0.5f,+0.5f,0), uv0 = new Vector2(0,0), normal = new Vector3(0, 0, -1)},
                new GLTFVertex{pos = new Vector3(+0.5f,+0.5f,0), uv0 = new Vector2(1,0), normal = new Vector3(0, 0, -1)},
                new GLTFVertex{pos = new Vector3(+0.5f,-0.5f,0), uv0 = new Vector2(1,1), normal = new Vector3(0, 0, -1)},
                new GLTFVertex{pos = new Vector3(-0.5f,-0.5f,0), uv0 = new Vector2(0,1), normal = new Vector3(0, 0, -1)},
            };

...
namespace BepuPlugin
{
    public class BepuScene<T> : IDisposable, IBepuScene<T>
    {
        ...
        public void RegisterCollisionListener(CollidableReference collidable, Action<CollisionEvent> collisionEvent = null, Action<CollisionEvent> continueEvent = null, Action<CollisionEvent> endEvent = null)
        {
            ...
            if(endEvent != null)
            {
                collisionEventHandler.AddEndHandler(collidable, endEvent);
            }
        }
        ...
        public void UnregisterCollisionListener(CollidableReference collidable)
        {
            ...
            collisionEventHandler.RemoveEndHandler(collidable);
        }

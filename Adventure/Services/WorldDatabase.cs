    ...
    class WorldDatabase : IWorldDatabase
    {
        ...
        private IEnumerable<IAreaBuilder> SetupAreaBuilder(IList<MonsterInfo> monsterInfo, FIRandom biomeRandom, FIRandom placementRandom, FIRandom elementalRandom, FIRandom treasureRandom, List<IntVector2> portalLocations, bool[,] usedSquares, bool[] usedIslands, csIslandMaze map)
        {
            ...
            //Phase 1
            {
                ...
                var uniqueTreasure = phase1UniqueTreasures.Count / 4;
                var stolenTreasure = phase1UniqueStolenTreasures.Count / 4;
            ...
            //Phase 2
            {
                ...
                var uniqueTreasure = phase2UniqueTreasures.Count / 4;
                var stolenTreasure = phase2UniqueStolenTreasures.Count / 4;
                ...
                areaBuilder.Treasure = new[] 
                {
                    RemoveRandomItem(phase2UniqueTreasures, treasureRandom), 
                    new Treasure(PotionCreator.CreateHealthPotion(phase2TreasureLevel)) 
                };
                areaBuilder.UniqueStealTreasure = new[]
                { 
                    RemoveRandomItem(phase2UniqueStolenTreasures, treasureRandom), 
                    RemoveRandomItem(phase2UniqueStolenTreasures, treasureRandom)
                };
                areaBuilder.StealTreasure = new[]
                {
            ...
            //Phase 3
            {
                ...
                areaBuilder.Treasure = new[] 
                { 
                    RemoveRandomItem(phase3UniqueTreasures, treasureRandom), 
                    new Treasure(PotionCreator.CreateHealthPotion(phase3TreasureLevel)) 
                };
                areaBuilder.UniqueStealTreasure = new[] 
                { 
                    RemoveRandomItem(phase3UniqueStolenTreasures, treasureRandom),
                    RemoveRandomItem(phase3UniqueStolenTreasures, treasureRandom)
                };
                areaBuilder.StealTreasure = new[]
                {

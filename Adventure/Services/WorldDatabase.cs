    ...
    class WorldDatabase : IWorldDatabase
    {
        ...
        private IEnumerable<IAreaBuilder> SetupAreaBuilder(int seed, FIRandom biomeRandom, FIRandom placementRandom, FIRandom elementalRandom, FIRandom treasureRandom, List<IntVector2> portalLocations, bool[,] usedSquares, bool[] usedIslands, csIslandMaze map)
        {
            ...
            //Phase 0
            {
                ...
                phase0UniqueTreasures.Add(new Treasure(ShieldCreator.CreateNormal(phase0TreasureLevel, phase0Adjective, false)));
                phase0UniqueTreasures.Add(new Treasure(DaggerCreator.CreateNormal(phase0TreasureLevel, phase0Adjective, false, false, nameof(Steal))));
            ...
            //Phase 1
            {
                ...
                phase1UniqueTreasures.Add(new Treasure(ShieldCreator.CreateNormal(phase1TreasureLevel, phase1Adjective, false)));
            ...
            //Phase 2
            {
                ...
                phase2UniqueTreasures.Add(new Treasure(BookCreator.CreateRestoration(phase2TreasureLevel, phase2Adjective, false, nameof(MegaCure), nameof(BattleCry), nameof(Focus))));
                phase2UniqueTreasures.Add(new Treasure(ShieldCreator.CreateNormal(phase2TreasureLevel, phase2Adjective, false)));
        ...
        public IEnumerable<ShopEntry> CreateShopItems(HashSet<PlotItems> plotItems)
        {
            if (plotItems.Contains(PlotItems.Phase3Shop))
            {
                ...
                {
                    yield return new ShopEntry($"{adjective} Shield", 1800, () => ShieldCreator.CreateNormal(treasureLevel, adjective, true), PlotItems.UniquePhase3Shield);
                }

...
{
    class FinalStaff : ISpriteAsset
    {
        public ISpriteAsset CreateAnotherInstance() => new FinalStaff();

        private const string colorMap = "Graphics/Sprites/Anomalous/Equipment/FinalStaff.png";
